(function () {
  ...
  const updateHightlightTheme = (theme) => {
    ...
    if (link) {
      ...
      link.href = `/static/highlight/${themeName}.min.css`;
    }
  };
  ...
  const updateGithubMarkdownTheme = (theme) => {
    ...
    if (link) {
      const themeName = theme === "dark" ? "github-markdown-dark" : "github-markdown-light";
      link.href = `https://cdnjs.cloudflare.com/ajax/libs/github-markdown-css/5.8.1/${themeName}.min.css`;
    }
  };
